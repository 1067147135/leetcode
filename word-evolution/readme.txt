...
ver5: Using unordered_set to implement Bi-directional BFS, give priority to expanding layers with a large number of elements, similarity/getNeighbor function implementation upgrade, 49 / 49, AC: 16 ms, 13.6 MB
